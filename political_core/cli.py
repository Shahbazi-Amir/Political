...
def _engine()->FactCheckEngine:
    ...
    settings=Settings();cache=build_cache_backend(settings.cache_backend,sqlite_path=settings.cache_path,max_rows=settings.cache_max_rows,redis_url=settings.redis_url,fail_open=settings.cache_fail_open,redis_default_ttl=settings.redis_default_ttl)
