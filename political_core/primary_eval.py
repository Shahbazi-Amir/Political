...
def primary_source_metrics(records:Iterable[Mapping[str,Any]])->dict[str,Any]:
    ...
    for row in records:
        ...
        if not is_auditable_verified_case(dict(row)):
    ...
    return {
        "reviewed_cases":reviewed,"structural_verified_cases":structural_verified,"rejected_non_auditable_verified":rejected_audit,
