...
class TelegramAdapter:
    application:PoliticalApplication;rate_limiter:SlidingWindowRateLimiter|None=None;concurrency_limiter:ConcurrencyLimiter|None=None;_last_result:dict[str,FactCheckResult]=field(default_factory=dict)
    def _remember(self,user_id:str,result:FactCheckResult)->None:self._last_result[str(user_id)]=result
    def _last(self,user_id:str)->FactCheckResult|None:return self._last_result.get(str(user_id))
